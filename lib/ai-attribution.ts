...
export function buildAttributionPrompt(
  ...
  return [
    ...
    'Use UNCERTAIN when the names or evidence are ambiguous.',
    'Write the justification in plain, simple English. Avoid legal jargon or complex words. Be direct, clear, and easy to understand.',
